<?php 
	...
	echo "<ul><li>" . _("The ") . '<a href="/ccft">' . _("Crawl Cosplay Forks Tournament") . '</a> (CCFT#2) ' . _("will start on Friday July 31st.") . '<img src="/img/misc/arrow-flashing-left.gif" height="16"></li>';
