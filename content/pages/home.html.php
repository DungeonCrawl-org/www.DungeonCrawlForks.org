<?php
	...
	echo     "<li>" . _("Before the end of July, the following will likely be happening:") . "</li></ul>";
	echo             _(" 1. The webtiles server CCO (cco.crawlcosplay.org) will be moved to a European server.");
	echo     		 _(" 2. A new Webtiles server will be setup in Ontario, Canada to be called: DCF (dcf.dungeoncrawlforks.org");
